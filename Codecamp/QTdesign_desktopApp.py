...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(500, 483)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(40, 10, 420, 41))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 40, 55, 13))
        ...
        self.niengRangCb.setGeometry(QtCore.QRect(190, 30, 90, 17))
        self.niengRangCb.setObjectName("niengRangCb")
        self.label_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_3.setGeometry(QtCore.QRect(80, 120, 70, 16))
        self.label_3.setObjectName("label_3")
        self.tayTrangCb = QtWidgets.QCheckBox(self.groupBox_2)
        self.tayTrangCb.setGeometry(QtCore.QRect(60, 30, 80, 17))
        self.tayTrangCb.setObjectName("tayTrangCb")
        self.nhoRangNum = QtWidgets.QSpinBox(self.groupBox_2)
        self.nhoRangNum.setGeometry(QtCore.QRect(170, 90, 55, 22))
        self.nhoRangNum.setObjectName("nhoRangNum")
        self.label_2 = QtWidgets.QLabel(self.groupBox_2)
        self.label_2.setGeometry(QtCore.QRect(80, 90, 55, 13))
        ...
        self.label_6.setGeometry(QtCore.QRect(300, 400, 55, 13))
